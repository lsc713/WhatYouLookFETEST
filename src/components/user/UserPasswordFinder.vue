...
<template>
    <form class="form_main" action="">
        ...
        <input placeholder="AccountID" id="accountId" class="inputField" type="text" v-model="passwordFinderForm.accountId">
        </div>
        ...
        <div class="inputContainer">
            ...
            <input placeholder="NickName" id="nickname" class="inputField" type="text" v-model="passwordFinderForm.nickname">
        </div>
                
        <button id="button" @click.prevent="getPasswordHint">Find</button>
